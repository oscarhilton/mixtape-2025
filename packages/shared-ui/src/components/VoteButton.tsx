...
export default function VoteButton({ playlistId, initialVotes }: VoteButtonProps) {
  ...
  return (
    <div className="mt-3 flex items-center space-x-2">
      <button
        ...
        className="px-4 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 disabled:bg-gray-300 transition-colors text-sm"
      >
